...
namespace Hazel
{
    ...
    namespace Utils
    {
        ...
        static const char* GetCacheDirectory()
        {
            ...
            return "HazelnutAssets/cache/shader/opengl";
        }
        ...
        : m_FilePath(filepath)
    {
        ...
        // Extract name from filepath - such as: assets/shaders/Texture.shader.glsl
